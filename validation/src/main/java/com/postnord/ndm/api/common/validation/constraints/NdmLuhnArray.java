...
import com.postnord.ndm.api.common.validation.validator.NdmLuhnArrayValidator;
...
@Retention(RUNTIME)
@Constraint(validatedBy = NdmLuhnArrayValidator.class)
@Documented
public @interface NdmLuhnArray {
